      ...
      <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-950/80 p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full rounded-lg bg-zinc-900 border border-zinc-800 px-4 py-3 text-sm"
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-emerald-600 py-3 text-black font-medium"
          >
